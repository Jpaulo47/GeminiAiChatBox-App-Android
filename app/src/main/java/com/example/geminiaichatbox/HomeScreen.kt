...
fun AppContent(viewModel: HomeViewModel = androidx.lifecycle.viewmodel.compose.viewModel()) {
    ...
    HomeScreen(uiState = appUiState.value) { userInput, selectedImages ->
        ...
        coroutineScope.launch {
            ...
            viewModel.questioning(userInput = userInput, selectedImages = bitmaps)
...
fun HomeScreen(
    ...
    val pickMediaLauncher =
        rememberLauncherForActivityResult(contract = ActivityResultContracts.PickMultipleVisualMedia()) { imageUri ->
            imageUris.addAll(imageUri)
        }

    Scaffold(topBar = {
        TopAppBar(
            title = { Text(text = "Gemini AI Chat Box") },
        ...
        Column {
            Row(
                ...
                IconButton(onClick = {
                    ...
                    Icon(
                        imageVector = Icons.Default.AddCircle, contentDescription = "Add Image"
                    )
                }
                ...
                IconButton(onClick = {
                    ...
                    if (userQues.isNotEmpty() && imageUris.isNotEmpty()) {
            ...
            when (uiState) {
                ...
                is HomeUIState.Initial -> {
                    Box(
                        ...
                        Text(text = "Welcome to Gemini AI Chat Box")
                    }
                }
